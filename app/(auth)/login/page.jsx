...
export default function LoginPage() {
  ...
  return (
    <div className='w-screen h-screen lg:grid lg:grid-cols-7 bg-gradient-to-b from-white to-[#D2DCFF]'>
      <div className='px-8 md:px-36 lg:px-12 lg:col-span-3 md:py-4 h-screen'>
      ...
      <div className='hidden bg-teal-950 rounded-tl-3xl rounded-bl-3xl lg:col-span-4 col-end-8 relative py-12 lg:flex lg:flex-col lg:justify-between'>
        <BackgroundLines>
          ...
          <Image
            src={illustration}
            alt='illustration'
            className='absolute bottom-32 h-[350px]'
          />
        </BackgroundLines>
